...
CREATE TABLE "rental_duration" (
    ...
    CONSTRAINT "rental_duration_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "rental_duration" ADD CONSTRAINT "rental_duration_tool_id_fkey" FOREIGN KEY ("tool_id") REFERENCES "tool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

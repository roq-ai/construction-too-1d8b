...
import { getRentalDurationById } from 'apiSdk/rental-durations';
...
function RentalDurationViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Rental Duration Detail View
          </Text>
          {hasAccess('rental_duration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/rental-durations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
